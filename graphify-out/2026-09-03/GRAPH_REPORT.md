...
2. `CacheManager` - 21 edges
3. `BuildEngine` - 20 edges
4. `JoltManifest` - 20 edges
5. `ToolchainManager` - 17 edges
6. `MavenClient` - 16 edges
...
Cohesion: 0.24
Nodes (18): Child, From, BuildEngine, Box, Error, Option, Path, PathBuf (+10 more)
...
### Community 5 - "ToolchainManager"
Cohesion: 0.16
Nodes (18): detect_java_vendor(), InstalledJdk, parse_java_major_version(), Box, Client, Default, Error, Option (+10 more)
